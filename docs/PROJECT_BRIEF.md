...
EVK QRNG 실행에서 측정한 공격별 검출 confidence와 threshold sweep 결과는
`docs/assets/evk_demo_report.json`, `docs/assets/evk_fpr_report.json`,
`docs/assets/evk_validation_report.json`에 기록되어 있다.
